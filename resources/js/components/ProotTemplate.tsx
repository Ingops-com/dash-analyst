...
interface ProotTemplateProps {
    initialData?: any;
    onSave: (data: any) => void;
    readOnly?: boolean;
}

export function ProotTemplate({ initialData, onSave, readOnly = false }: ProotTemplateProps) {
    ...
    return (
        <div className="space-y-4">
            <div className="text-sm text-muted-foreground space-y-2">
                <p><strong>ASPECTOS A EVALUAR - MANIPULADOR DE ALIMENTOS:</strong></p>
                <p>Para que el personal cumpla a cabalidad, debe mantener las uñas cortas y limpias, estar sin maquillaje ni accesorios, no tener olores fuertes, utilizar uniforme limpio. El lavado de manos es obligatorio. De igual manera, el uso de tapabocas y cofia es obligatorio.</p>
                
                <p><strong>ASPECTOS A EVALUAR - INSTALACIONES LOCATIVAS Y PLAGAS:</strong></p>
                <p>Las áreas deben estar limpias y libres de plagas. Se debe evidenciar limpieza constante, áreas libres de empaques, residuos y escombros. Las ventanas deben tener malla milimétrica en buen estado.</p>
            </div>
